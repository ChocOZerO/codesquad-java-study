...
public class Rewards {
    ...
    private int match4;
    private int match5;
    private int match5Bonus;
    private int match6;
    
    public Rewards(int match3, int match4, int match5, int match5Bonus, int match6) {
        this.match3 = match3;
        this.match4 = match4;
        this.match5 = match5;
    ...
    private int getMatch5BonusAmount() {
        return this.match5Bonus * 30000000;
    }
    ...
    private int getTotalAmount() {
        return this.getMatch3Amount() + this.getMatch4Amount() + this.getMatch5Amount() + this.getMatch5BonusAmount() + this.getMatch6Amount();
    }
